            ...
            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                <div class="dataTable-top">
                    ...
                    <div class="dataTable-search d-flex">
                        <div class="col-4">
                            <a href="#!" data-bs-toggle="modal" data-bs-target="#addModal" class="btn btn-primary btn-sm h-100">{{ $t('add_new_group') }}</a>
                        </div>
                        <div class="col-8">
                ...
                <div class="dataTable-container">
                    <table id="datatablesSimple" class="dataTable-table">
                        ...
                        <tbody>
                            <tr v-for="(group,index) in items" :key="index">
                                <td>{{ group.title }}</td>
                                <td>{{ $t(group.default.toString()) }}</td>
                                <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addModalLabel">{{ $t('add_new_group') }}</h5>
...
export default {
    ...
    methods: {
        ...
        async get(){
            const response = await adminService.groupList(this.table)
        ...
        async saveGroup(){
            const response = await adminService.groupSave(this.edit)
            if(response.status == 1){
        ...
        async addGroup(){
            const response = await adminService.groupAdd(this.add)
            if(response.status == 1){
